...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="assets/images/favicons/favicon2-32x32.png" />
    <link rel="manifest" href="assets/images/favicons/site.webmanifest" />
    <meta name="description" content="custom web creation agency for development of websites" />
...
<body class="custom-cursor">
    ...
    <div class="preloader">
        <div class="preloader__image" style="background-image: url(assets/images/favicons/favicon2-32x32.png);"></div>
    </div>
    <!-- /.preloader -->
       ...
       <?php include("header.php"); ?>
		...
		"margin": 0
            ...
            <div class="main-slider__socails">
                ...
                <a href="https://www.facebook.com/kaushal singh"><i class="fab fa-facebook"></i></a>
                <a href="https://www.pinterest.com/"><i class="fab fa-pinterest-p"></i></a>
                <a href="https://www.instagram.com/custom_web_creation"><i class="fab fa-instagram"></i></a>
            </div>
            <!-- social end -->
            <!-- phone start -->
            <!-- phone end -->
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp animated" data-wow-delay="200ms">
                        <div class="feature-one__item">
                            ...
                            <div class="feature-one__item__hover-content">
                                ...
                                <a class="feature-one__item__hover-content__btn" href="website-development.php">Read More<span class="icon-down-right"></span></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp animated" data-wow-delay="300ms">
                        <div class="feature-one__item">
                            ...
                            <div class="feature-one__item__hover-content">
                                ...
                                <p class="feature-one__item__hover-content--text">This present moment is perfect simply due to the fact.</p>
                                <a class="feature-one__item__hover-content__btn" href="graphic-designing.php">Read More<span class="icon-down-right"></span></a>
                            </div>
                            <!-- feature hover content -->
                        </div>
                        <!-- feature item end -->
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp animated" data-wow-delay="400ms">
                        <div class="feature-one__item">
                            ...
                            <div class="feature-one__item__hover-content">
                                ...
                                <p class="feature-one__item__hover-content--text">This present moment is perfect simply due to the fact.</p>
                                <a class="feature-one__item__hover-content__btn" href="digital-marketing.php">Read More<span class="icon-down-right"></span></a>
                            </div>
                            <!-- feature hover content -->
                        </div>
                        <!-- feature item end -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="about-one__content">
                            ...
                            <!-- section-title -->
                             <p>Custom Web Creation was born out of a passion for helping businesses navigate the complexities of the digital world. With years of experience in web development, design, and marketing, our founders recognized a need for a one-stop solution where clients could get all their digital needs met under one roof. Today, we proudly serve clients across various industries, helping them achieve their goals through tailored digital solutions.<br>
</p>
                            <a href="about.php" class="ogency-btn">Discover More</a>
                        </div>
                        <!-- about content end-->
                    </div>
                </div>
            ...
            <div class="container">
                <div class="video-one__banner wow fadeInUp animated animated" data-wow-delay="100ms">
                    ...
                    <div class="video-one__banner__shape wow fadeInRight animated animated" data-wow-delay="300ms">
                        <img src="assets/images/backgrounds/video-bg-shape-1-11.png" alt="ogency">
                    </div>
                    <!-- curved-circle start-->
                    <div class="video-one__banner__curved-circle-box wow fadeInUp animated animated" data-wow-delay="400ms">
                        <div class="curved-circle">
                            <span class="curved-circle-item">
                                custom&emsp;web&emsp;creation&emsp;
                            </span>
                        </div>
                        <!-- video btn start -->
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 wow fadeInUp animated" data-wow-delay="100ms">
                        <div class="service-one__item">
                            ...
                            <!-- /.service-content -->
                            <a class="service-one__item__btn" href="website-development.php">Read More<span class="icon-down-right"></span></a>
                            <!-- /.service-read-more -->
                        </div>
                        <!-- /.service-card-one -->
                    </div>
                    <div class="col-lg-3 col-md-6 wow fadeInUp animated" data-wow-delay="200ms">
                        <div class="service-one__item">
                            ...
                            <p class="service-one__item__text">Providing the solutions for your all business</p>
                            <!-- /.service-content -->
                            <a class="service-one__item__btn" href="graphic-designing.php">Read More<span class="icon-down-right"></span></a>
                            <!-- /.service-read-more -->
                        </div>
                        <!-- /.service-card-one -->
                    </div>
                    <div class="col-lg-3 col-md-6 wow fadeInUp animated" data-wow-delay="100ms">
                        <div class="service-one__item">
                            ...
                            <p class="service-one__item__text">Providing the solutions for your all business</p>
                            <!-- /.service-content -->
                            <a class="service-one__item__btn" href="digital-marketing.php">Read More<span class="icon-down-right"></span></a>
                            <!-- /.service-read-more -->
                        </div>
                        <!-- /.service-card-one -->
                    </div>
                    <div class="col-lg-3 col-md-6 wow fadeInUp animated" data-wow-delay="100ms">
                        <div class="service-one__item">
                            ...
                            <!-- /.service-icon -->
                            <h3 class="service-one__item__title">
                                <a href="video-editing.php"> Video <br> editing</a>
                            </h3>
                            <!-- /.service-title -->
                            <p class="service-one__item__text">Providing the solutions for your all business</p>
                            <!-- /.service-content -->
                            <a class="service-one__item__btn" href="video-editing.php">Read More<span class="icon-down-right"></span></a>
                            <!-- /.service-read-more -->
                        </div>
                        <!-- /.service-card-one -->
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 wow fadeInUp animated" data-wow-delay="100ms">
                        <div class="team-one__item">
                            ...
                            <div class="team-one__item__content">
                                <span class="team-one__item__designation">Senior Developer</span>
                                <!-- /.team-designation -->
                                <h3 class="team-one__item__title">
                                    <a href="team-details.html">Kaushal Singh</a>
                                </h3>
                                <!-- /.team-name -->
                                <div class="team-one__item__social-wrapper">
                                    ...
                                    <div class="team-one__item__social">
                                        ...
                                        <a href="https://www.pinterest.com/"><i class="fab fa-pinterest-p"></i></a>
                                        <a href="https://www.instagram.com/btwitskaushal"><i class="fab fa-instagram"></i></a>
                                    </div>
                                    <!-- /.team-social -->
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-md-6 wow fadeInUp animated" data-wow-delay="200ms">
                        <div class="team-one__item">
                            <div class="team-one__item__image">
                                <img src="assets/images/team/adi.jpg" alt="ogency">
                            </div>
                            <!-- /.team-image -->
                            <div class="team-one__item__content">
                                <span class="team-one__item__designation">Junior Developer</span>
                                <!-- /.team-designation -->
                                <h3 class="team-one__item__title">
                                    <a href="team-details.html">Aditya</a>
                                </h3>
                                <!-- /.team-name -->
                                <div class="team-one__item__social-wrapper">
                                    <a class="team-one__item__links" href="#"><span class="fas fa-share-alt"></span></a>
                                    ...
                                    <div class="team-one__item__social">
                                        ...
                                        <a href="https://www.facebook.com/"><i class="fab fa-facebook"></i></a>
                                        <a href="https://www.pinterest.com/"><i class="fab fa-pinterest-p"></i></a>
                                        <a href="https://www.instagram.com/20._aadi"><i class="fab fa-instagram"></i></a>
                                    </div>
                                    <!-- /.team-social -->
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-md-6 wow fadeInUp animated" data-wow-delay="300ms">
                        <div class="team-one__item">
                            <div class="team-one__item__image">
                                <img src="assets/images/team/anurag.jpg" alt="ogency">
                            </div>
                            <!-- /.team-image -->
                            <div class="team-one__item__content">
                                <span class="team-one__item__designation">Junior Developer</span>
                                <!-- /.team-designation -->
                                <h3 class="team-one__item__title">
                                    <a href="team-details.html">Anurag</a>
                                </h3>
                                <!-- /.team-name -->
                                <div class="team-one__item__social-wrapper">
                                    <a class="team-one__item__links" href="#"><span class="fas fa-share-alt"></span></a>
                                    ...
                                    <div class="team-one__item__social">
                                        ...
                                        <a href="https://www.facebook.com/"><i class="fab fa-facebook"></i></a>
                                        <a href="https://www.pinterest.com/"><i class="fab fa-pinterest-p"></i></a>
                                        <a href="https://www.instagram.com/anuragbhadula"><i class="fab fa-instagram"></i></a>
                                    </div>
                                    <!-- /.team-social -->
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 wow fadeInUp animated" data-wow-delay="100ms">
                        <div class="fact-one__item text-center">
                            <div class="fact-one__item__icon"><span class="icon-complete"></span></div>
                            <!-- /.fact-one__icon -->
                            <div class="fact-one__item__count">
                                <span class="count-box">
                                    <span class="count-text" data-stop="105" data-speed="1500"></span>
                                </span>
                            </div>
                            <!-- /.fact-one__count -->
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp animated" data-wow-delay="200ms">
                        <div class="fact-one__item text-center">
                            <div class="fact-one__item__icon"><span class="icon-award"></span></div>
                            <!-- /.fact-one__icon -->
                            <div class="fact-one__item__count">
                                <span class="count-box">
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp animated" data-wow-delay="300ms">
                        <div class="fact-one__item text-center">
                            ...
                            <div class="fact-one__item__count">
                                <span class="count-box">
                                    <span class="count-text" data-stop="67" data-speed="1500"></span>
                                </span>
                            </div>
                            <!-- /.fact-one__count -->
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp animated" data-wow-delay="400ms">
                        <div class="fact-one__item text-center">
                            <div class="fact-one__item__icon"><span class="icon-team"></span></div>
                            <!-- /.fact-one__icon -->
                            <div class="fact-one__item__count">
                                <span class="count-box">
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index.php" aria-label="logo image"><img src="assets/images/logo-light.png" width="36" alt="ogency" /></a>
            </div>
            <!-- /.logo-box -->
            ...
            <ul class="mobile-nav__contact list-unstyled">
                <li>
                    ...
                    <a href="mailto:customwebcreation799@gmail.com">customwebcreation799@gmail.com</a>
                </li>
                <li>
                    <i class="icon-phone-call"></i>
                    <a href="tel:7065298782">7065298782</a>
                </li>
            </ul>
            <!-- /.mobile-nav__contact -->
